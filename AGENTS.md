...
Codex and Cursor read this file natively as `AGENTS.md`. Claude Code does not read
`AGENTS.md`, so `CLAUDE.md` is a symlink to it. Edit this file; never edit through the
symlink.
